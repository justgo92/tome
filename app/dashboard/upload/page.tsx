...
export default function DocumentUploadPage() {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-lg shadow-glass overflow-hidden mb-6">
        <div className="p-6">
          ...
          {uploadMethod === 'direct' ? (
            ...
            >
              ...
              <button
                type="button"
                className="mt-4 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-tome-cyan hover:bg-tome-cyan-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-tome-cyan"
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-lg shadow-glass overflow-hidden mb-6">
          <div className="p-6">
            ...
            <div className="mt-6 flex justify-end space-x-4">
              <button
                className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-tome-purple hover:bg-tome-purple-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-tome-purple"
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                ...
                <div className="mt-4 flex space-x-3">
                  <button className="px-3 py-1.5 bg-tome-cyan text-white text-sm rounded-md hover:bg-tome-cyan-dark transition-colors">
